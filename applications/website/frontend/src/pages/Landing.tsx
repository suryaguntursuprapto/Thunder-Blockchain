    ...
    <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
      <div className="container">
        ...
        <div className="nav-cta">
          ...
          <Link to="/thunderscan/testnet" className="btn btn-primary">⚡ ThunderScan</Link>
        </div>
      </div>
    </nav>
  )
    ...
    <section className="section" id="ecosystem" ref={ref} style={{ background: 'var(--bg-secondary)' }}>
      <div className="container">
        ...
        <div className="eco-grid">
          <div className="glass-card eco-card reveal"><span className="eco-icon">🔍</span><h3 className="eco-title">ThunderScan</h3><p className="eco-desc">Block explorer.</p><Link to="/thunderscan/testnet" className="eco-link">Explore Testnet →</Link></div>
